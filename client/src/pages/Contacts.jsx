  ...
  return (
    <section className="bg-gray-50 py-20 px-4 sm:px-8 text-primary">
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://ваш-домен.рф/contacts" />
        ...
        <meta property="og:url" content="https://ваш-домен.рф/contacts" />
        <meta property="og:image" content="https://ваш-домен.рф/preview.jpg" />
        ...
        <meta name="twitter:image" content="https://ваш-домен.рф/preview.jpg" />
      </Helmet>
