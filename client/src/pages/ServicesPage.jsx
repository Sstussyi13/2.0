  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://ваш-домен.рф/services" />
        ...
        <meta property="og:url" content="https://ваш-домен.рф/services" />
        <meta property="og:image" content="https://ваш-домен.рф/preview-services.jpg" />
        ...
        <meta name="twitter:image" content="https://ваш-домен.рф/preview-services.jpg" />
      </Helmet>
